...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->DEFAULT_MODES_VZW:[I
...
.method static synthetic access$000(Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;

    .prologue
    .line 44
    iget v0, p0, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->mCurrent:I

    return v0
.end method

.method static synthetic access$100(Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;)Lcom/android/settings_ex/deviceinfo/UsbBackend;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;
...
.method static synthetic access$200(Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;)Landroid/app/AlertDialog;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->mLayoutInflater:Landroid/view/LayoutInflater;
    ...
    iput-object v2, p0, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->mDialog:Landroid/app/AlertDialog;

    .line 100
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->mDialog:Landroid/app/AlertDialog;
    ...
    new-instance v2, Lcom/android/settings_ex/deviceinfo/UsbBackend;

    invoke-direct {v2, p0}, Lcom/android/settings_ex/deviceinfo/UsbBackend;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->mBackend:Lcom/android/settings_ex/deviceinfo/UsbBackend;

    .line 105
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->mBackend:Lcom/android/settings_ex/deviceinfo/UsbBackend;

    invoke-virtual {v2}, Lcom/android/settings_ex/deviceinfo/UsbBackend;->getCurrentMode()I

    move-result v2

    iput v2, p0, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->mCurrent:I
    ...
    .local v1, "i":I
    :goto_0
    sget-object v2, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->DEFAULT_MODES_VZW:[I
    ...
    sget-object v5, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->DEFAULT_MODES_VZW:[I

    aget v5, v5, v1

    invoke-virtual {v2, v5}, Lcom/android/settings_ex/deviceinfo/UsbBackend;->isModeSupported(I)Z
    ...
    iget v2, p0, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->mCurrent:I

    sget-object v6, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->DEFAULT_MODES_VZW:[I
    ...
    :goto_1
    invoke-direct {p0, v5, v2, v0}, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->inflateOption(IZLandroid/widget/LinearLayout;)V
    ...
    :goto_2
    sget-object v2, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->DEFAULT_MODES:[I
    ...
    sget-object v5, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->DEFAULT_MODES:[I
...
.method public onPause()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/deviceinfo/UsbModeChooserActivity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    :try_end_0
