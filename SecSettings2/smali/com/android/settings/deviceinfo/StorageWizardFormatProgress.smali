...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mSkipDoneActivity:Z
...
.method static synthetic access$202(Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 48
    iput-boolean p1, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mSkipDoneActivity:Z

    return p1
.end method

.method static synthetic access$300(Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;
...
.method static synthetic access$500(Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;
...
.method private onFormatFinished()V
    ...
    .line 273
    iget-object v5, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mStorage:Landroid/os/storage/StorageManager;

    invoke-virtual {v5, v0}, Landroid/os/storage/StorageManager;->forgetVolume(Ljava/lang/String;)V

    .line 277
    :cond_0
    iget-boolean v5, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mFormatPrivate:Z
    ...
    :goto_0
    iget-boolean v5, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mFromFactoryReset:Z
    ...
    invoke-virtual {p0, v4, v1}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->setResult(ILandroid/content/Intent;)V
    ...
    .line 297
    :cond_4
    iget-boolean v5, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mSkipDoneActivity:Z
    ...
    .line 303
    iput-boolean v4, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mSkipDoneActivity:Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->setContentView(I)V

    .line 69
    invoke-virtual {p0, v5}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->setKeepScreenOn(Z)V
    ...
    iput-boolean v1, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mFromFactoryReset:Z
    ...
    iput-boolean v1, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mFormatPrivate:Z

    .line 76
    iget-boolean v1, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mFormatPrivate:Z

    invoke-virtual {p0, v1}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->setIllustrationInternal(Z)V
    ...
    iget-object v3, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mDisk:Landroid/os/storage/DiskInfo;
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->setHeaderText(I[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->setBodyText(I[Ljava/lang/String;)V

    .line 81
    invoke-virtual {p0}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->getViewGroup()Landroid/view/ViewGroup;
    ...
    check-cast v1, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress$PartitionTask;

    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mTask:Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress$PartitionTask;

    .line 84
    iget-object v1, p0, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;->mTask:Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress$PartitionTask;

    if-nez v1, :cond_1

    .line 85
    new-instance v1, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress$PartitionTask;

    invoke-direct {v1}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress$PartitionTask;-><init>()V
    ...
    invoke-virtual {v1, p0}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress$PartitionTask;->setActivity(Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/settings_ex/deviceinfo/StorageWizardFormatProgress$PartitionTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
