...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings_ex/vpn2/VpnSettings$3;-><init>(Lcom/android/settings_ex/vpn2/VpnSettings;)V
...
.method static synthetic access$000(Lcom/android/settings_ex/vpn2/VpnSettings;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$100(Lcom/android/settings_ex/vpn2/VpnSettings;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/vpn2/VpnSettings;

    .prologue
    .line 90
    iget-object v0, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConfigPreferences:Ljava/util/HashMap;

    return-object v0
.end method

.method static synthetic access$102(Lcom/android/settings_ex/vpn2/VpnSettings;Ljava/util/HashMap;)Ljava/util/HashMap;
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/vpn2/VpnSettings;
    ...
    .prologue
    .line 90
    iput-object p1, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConfigPreferences:Ljava/util/HashMap;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    .prologue
    .line 313
    iget-object v10, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUpdater:Landroid/os/Handler;
    ...
    .line 318
    iget-object v10, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConfigPreferences:Ljava/util/HashMap;

    invoke-virtual {v10}, Ljava/util/HashMap;->clear()V

    .line 319
    iget-object v10, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mAppPreferences:Ljava/util/HashMap;

    invoke-virtual {v10}, Ljava/util/HashMap;->clear()V

    .line 322
    iget-object v10, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mKeyStore:Landroid/security/KeyStore;

    const/4 v11, 0x0

    new-array v11, v11, [I

    invoke-static {v10, v11}, Lcom/android/settings_ex/vpn2/VpnSettings;->loadVpnProfiles(Landroid/security/KeyStore;[I)Ljava/util/List;
    ...
    :cond_1
    new-instance v6, Lcom/android/settings_ex/vpn2/ConfigPreference;

    iget-object v10, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mManageListener:Landroid/view/View$OnClickListener;

    invoke-direct {v6, v4, v10, v8}, Lcom/android/settings_ex/vpn2/ConfigPreference;-><init>(Landroid/content/Context;Landroid/view/View$OnClickListener;Lcom/android/internal/net/VpnProfile;)V

    .line 331
    .local v6, "pref":Lcom/android/settings_ex/vpn2/ConfigPreference;
    invoke-virtual {v6, p0}, Lcom/android/settings_ex/vpn2/ConfigPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
    ...
    .line 334
    iget v10, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->isUserChangeProfilesAllowed:I
    ...
    :goto_2
    invoke-virtual {v6, v10}, Lcom/android/settings_ex/vpn2/ConfigPreference;->enableManage(Z)V
    ...
    .line 340
    .end local v4    # "mContext":Landroid/content/Context;
    .end local v6    # "pref":Lcom/android/settings_ex/vpn2/ConfigPreference;
    .end local v8    # "profile":Lcom/android/internal/net/VpnProfile;
    :cond_3
    ...
    invoke-static {v10, v11}, Lcom/android/settings_ex/vpn2/VpnSettings;->getVpnIdentifier(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 342
    .local v3, "key":Ljava/lang/String;
    new-instance v6, Lcom/android/settings_ex/vpn2/AppPreference;

    invoke-virtual {p0}, Lcom/android/settings_ex/vpn2/VpnSettings;->getActivity()Landroid/app/Activity;

    move-result-object v10

    iget-object v11, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mManageListener:Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v6, v10, v11, v12, v13}, Lcom/android/settings_ex/vpn2/AppPreference;-><init>(Landroid/content/Context;Landroid/view/View$OnClickListener;Ljava/lang/String;I)V

    .line 344
    .local v6, "pref":Lcom/android/settings_ex/vpn2/AppPreference;
    invoke-virtual {v6, p0}, Lcom/android/settings_ex/vpn2/AppPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
    ...
    :try_start_0
    iput-object v10, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConnectedLegacyVpn:Lcom/android/internal/net/LegacyVpnInfo;

    .line 353
    iget-object v10, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConnectivityService:Landroid/net/IConnectivityManager;
    ...
    check-cast v7, Lcom/android/settings_ex/vpn2/ConfigPreference;

    .line 356
    .local v7, "preference":Lcom/android/settings_ex/vpn2/ConfigPreference;
    if-eqz v7, :cond_5

    .line 357
    iget v10, v2, Lcom/android/internal/net/LegacyVpnInfo;->state:I

    invoke-virtual {v7, v10}, Lcom/android/settings_ex/vpn2/ConfigPreference;->setState(I)V

    .line 358
    iput-object v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConnectedLegacyVpn:Lcom/android/internal/net/LegacyVpnInfo;

    .line 363
    .end local v7    # "preference":Lcom/android/settings_ex/vpn2/ConfigPreference;
    :cond_5
    iget-object v10, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUserManager:Landroid/os/UserManager;
    ...
    check-cast v7, Lcom/android/settings_ex/vpn2/AppPreference;

    .line 368
    .local v7, "preference":Lcom/android/settings_ex/vpn2/AppPreference;
    if-eqz v7, :cond_6

    .line 369
    const/4 v10, 0x3

    invoke-virtual {v7, v10}, Lcom/android/settings_ex/vpn2/AppPreference;->setState(I)V
    :try_end_0
    ...
    .end local v3    # "key":Ljava/lang/String;
    .end local v7    # "preference":Lcom/android/settings_ex/vpn2/AppPreference;
    .end local v8    # "profile":Landroid/os/UserHandle;
    :catch_0
    move-exception v10
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/vpn2/VpnSettings;->getResources()Landroid/content/res/Resources;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUserManager:Landroid/os/UserManager;

    .line 135
    iget-object v1, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUserManager:Landroid/os/UserManager;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConnectivityManager:Landroid/net/ConnectivityManager;
...
.method public onDestroy()V
    ...
    .line 530
    :goto_0
    invoke-direct {p0}, Lcom/android/settings_ex/vpn2/VpnSettings;->removePreferences()V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 205
    :pswitch_0
    iget v5, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->isUserAddProfilesAllowed:I
    ...
    invoke-static {p0, v2, v4, v3}, Lcom/android/settings_ex/vpn2/ConfigDialogFragment;->show(Lcom/android/settings_ex/vpn2/VpnSettings;Lcom/android/internal/net/VpnProfile;ZZ)V
    ...
    :pswitch_1
    iget v5, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->isUserSetAlwaysOnAllowed:I
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    .line 193
    :cond_0
    iget v0, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->isUserAddProfilesAllowed:I
    ...
    iget v3, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->isUserSetAlwaysOnAllowed:I
...
.method public onResume()V
    ...
    .line 236
    iget-object v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUserManager:Landroid/os/UserManager;
    ...
    .line 240
    iput-boolean v6, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUnavailable:Z
    ...
    iput v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->isUserAddProfilesAllowed:I
    ...
    iput v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->isUserChangeProfilesAllowed:I
    ...
    iput v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->isUserSetAlwaysOnAllowed:I
    ...
    .line 258
    iget-boolean v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUnavailable:Z
    ...
    .line 265
    invoke-virtual {p0}, Lcom/android/settings_ex/vpn2/VpnSettings;->getContext()Landroid/content/Context;
    ...
    .line 275
    :cond_4
    iget-object v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConnectivityManager:Landroid/net/ConnectivityManager;

    sget-object v5, Lcom/android/settings_ex/vpn2/VpnSettings;->VPN_REQUEST:Landroid/net/NetworkRequest;

    iget-object v6, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    .line 278
    iget-object v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUpdater:Landroid/os/Handler;
    ...
    iput-object v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUpdater:Landroid/os/Handler;
