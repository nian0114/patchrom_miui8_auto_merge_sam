...
.method private createDialog(I)V
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->getWindow()Landroid/view/Window;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->mAlert:Lcom/android/internal/app/AlertController;

    .line 153
    iget-object v0, p0, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;
    ...
    .line 156
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->getString(I)Ljava/lang/String;
    ...
    .line 162
    invoke-virtual {p0, v5}, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->setVisible(Z)V
    ...
    .line 175
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->setVisible(Z)V
...
.method private proceedAndFinish()V
    ...
    .line 228
    iget-object v6, p0, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->mLocalAdapter:Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;

    invoke-virtual {v6}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;->getDiscoverableTimeout()I
    ...
    :goto_0
    iget-boolean v6, p0, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->mEnableOnly:Z
    ...
    :cond_0
    :goto_1
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->setResult(I)V
    ...
    iget v7, p0, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->mTimeout:I

    invoke-virtual {v6, v8, v7}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;->setScanMode(II)Z
    ...
    iget v8, p0, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->mTimeout:I
    ...
    invoke-virtual {v6}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;->setManufacturerData()V
    ...
    invoke-virtual {v6, v7}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;->setDiscoverableTimeout(I)V
...
.method public cancel()V
    ...
    .prologue
    .line 313
    iget-object v1, p0, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    :try_end_0
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 200
    :cond_1
    iput-boolean v2, p0, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->mUserConfirmed:Z
    ...
    .line 207
    :cond_2
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->setVisible(Z)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    :cond_1
    :goto_1
    invoke-direct {p0, v0}, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->createDialog(I)V

    .line 148
    invoke-virtual {p0}, Lcom/android/settings_ex/bluetooth/RequestPermissionActivity;->setupAlert()V
