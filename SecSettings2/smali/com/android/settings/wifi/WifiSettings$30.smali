...
.method public onItemClick(Lcom/sec/android/touchwiz/widget/TwAdapterView;Landroid/view/View;IJ)V
    ...
    invoke-static {v8}, Lcom/android/settings/wifi/WifiSettings;->access$3100(Lcom/android/settings/wifi/WifiSettings;)Lcom/sec/android/touchwiz/widget/TwListView;
    ...
    invoke-static {v8}, Lcom/android/settings/wifi/WifiSettings;->access$3200(Lcom/android/settings/wifi/WifiSettings;)Lcom/android/settings/wifi/AccessPointListAdapter;

    move-result-object v8

    invoke-virtual {v8, p3}, Lcom/android/settings/wifi/AccessPointListAdapter;->getItem(I)Ljava/lang/Object;
    ...
    invoke-static {v8, v5}, Lcom/android/settings/wifi/WifiSettings;->access$3302(Lcom/android/settings/wifi/WifiSettings;Lcom/android/settings/wifi/AccessPoint;)Lcom/android/settings/wifi/AccessPoint;
    ...
    iget-object v10, p0, Lcom/android/settings/wifi/WifiSettings$30;->this$0:Lcom/android/settings/wifi/WifiSettings;

    # getter for: Lcom/android/settings/wifi/WifiSettings;->mSelectedAccessPoint:Lcom/android/settings/wifi/AccessPoint;
    invoke-static {v10}, Lcom/android/settings/wifi/WifiSettings;->access$3300(Lcom/android/settings/wifi/WifiSettings;)Lcom/android/settings/wifi/AccessPoint;
    ...
    invoke-static {v8}, Lcom/android/settings/wifi/WifiSettings;->access$3400(Lcom/android/settings/wifi/WifiSettings;)Z
    ...
    # getter for: Lcom/android/settings/wifi/WifiSettings;->mSelectedAccessPoint:Lcom/android/settings/wifi/AccessPoint;
    invoke-static {v8}, Lcom/android/settings/wifi/WifiSettings;->access$3300(Lcom/android/settings/wifi/WifiSettings;)Lcom/android/settings/wifi/AccessPoint;
    ...
    iget-object v8, v8, Lcom/android/settings/wifi/WifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    # getter for: Lcom/android/settings/wifi/WifiSettings;->mSelectedAccessPoint:Lcom/android/settings/wifi/AccessPoint;
    invoke-static {v9}, Lcom/android/settings/wifi/WifiSettings;->access$3300(Lcom/android/settings/wifi/WifiSettings;)Lcom/android/settings/wifi/AccessPoint;
    ...
    invoke-static {v8, v9}, Lcom/android/settings/wifi/WifiSettings;->access$3502(Lcom/android/settings/wifi/WifiSettings;Lcom/android/settings/wifi/AccessPoint;)Lcom/android/settings/wifi/AccessPoint;
    ...
    invoke-static {v8, v9}, Lcom/android/settings/wifi/WifiSettings;->access$3602(Lcom/android/settings/wifi/WifiSettings;Z)Z
    ...
    invoke-static {v8}, Lcom/android/settings/wifi/WifiSettings;->access$3800(Lcom/android/settings/wifi/WifiSettings;)Z
    ...
    invoke-static {v9, v10}, Lcom/android/settings/wifi/WifiSettings;->access$3700(Lcom/android/settings/wifi/WifiSettings;Lcom/android/settings/wifi/AccessPoint;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v8, Lcom/android/settings/wifi/AccessPoint;->bssid:Ljava/lang/String;
    ...
    invoke-virtual {v8}, Lcom/android/settings/wifi/WifiSettings;->getActivity()Landroid/app/Activity;
    ...
    invoke-virtual {v8}, Lcom/android/settings/wifi/AccessPoint;->isVendorAccessPoint()Z
    ...
    invoke-static {v8}, Lcom/android/settings/wifi/WifiSettings;->access$3900(Lcom/android/settings/wifi/WifiSettings;)Z
    ...
    # getter for: Lcom/android/settings/wifi/WifiSettings;->mWeChatAccessPoint:Lcom/android/settings/wifi/WeChatAccessPoint;
    invoke-static {v8}, Lcom/android/settings/wifi/WifiSettings;->access$4000(Lcom/android/settings/wifi/WifiSettings;)Lcom/android/settings/wifi/WeChatAccessPoint;
    ...
    iget-object v10, v10, Lcom/android/settings/wifi/AccessPoint;->bssid:Ljava/lang/String;

    invoke-virtual {v8, v9, v10}, Lcom/android/settings/wifi/WeChatAccessPoint;->isWeChatAccessPoint(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget v9, v9, Lcom/android/settings/wifi/AccessPoint;->mRssi:I
    ...
    iget-boolean v8, v8, Lcom/android/settings/wifi/AccessPoint;->mIsCaptivePortal:Z
    ...
    iget-boolean v8, v8, Lcom/android/settings/wifi/AccessPoint;->mIsAuthenticated:Z
    ...
    invoke-virtual {v8}, Lcom/android/settings/wifi/AccessPoint;->isSupportedSecurityType()Z
    ...
    invoke-static {v8}, Lcom/android/settings/wifi/WifiSettings;->access$000(Lcom/android/settings/wifi/WifiSettings;)Z
    ...
    invoke-static {v8, v9, v10}, Lcom/android/settings/wifi/WifiSettings;->access$4100(Lcom/android/settings/wifi/WifiSettings;Lcom/android/settings/wifi/AccessPoint;Z)V
    ...
    invoke-virtual {v8}, Lcom/android/settings/wifi/AccessPoint;->generateOpenNetworkConfig()V
    ...
    invoke-static {v8}, Lcom/android/settings/wifi/WifiSettings;->access$4202(Z)Z
