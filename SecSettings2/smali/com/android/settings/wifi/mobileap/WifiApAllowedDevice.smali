...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedList;)V
    ...
    .param p4, "fragment"    # Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedList;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->setLayoutResource(I)V
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->mMenuHasFocus:Z
...
.method static synthetic access$000(Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;
...
.method static synthetic access$102(Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 31
    iput-boolean p1, p0, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->mMenuHasFocus:Z
...
.method protected onBindView(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 58
    new-instance v0, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice$1;

    invoke-direct {v0, p0}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice$1;-><init>(Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;)V

    invoke-virtual {v7, v0}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 65
    new-instance v0, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice$2;

    invoke-direct {v0, p0}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice$2;-><init>(Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;)V

    invoke-virtual {v7, v0}, Landroid/widget/LinearLayout;->setOnFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V

    .line 77
    :cond_0
    iget-boolean v0, p0, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->mMenuHasFocus:Z
    ...
    new-instance v1, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice$3;

    invoke-direct {v1, p0}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice$3;-><init>(Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;)V

    invoke-virtual {v0, v1}, Lcom/android/settings_ex/wifi/mobileap/WifiApWhitelistDialog;->setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 144
    check-cast v0, Lcom/android/settings_ex/wifi/mobileap/WifiApWhitelistDialog;
    ...
    invoke-virtual {p1}, Lcom/android/settings_ex/wifi/mobileap/WifiApWhitelistDialog;->getMac()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->update(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 146
    invoke-virtual {p0, v1, v1}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->update(Ljava/lang/String;Ljava/lang/String;)Z
...
.method update(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v4, p0, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->mName:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->mName:Ljava/lang/String;
    ...
    invoke-virtual {v2, v4, p2}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedList;->showAlreadyInTableToast(Ljava/lang/String;Ljava/lang/String;)V

    .line 127
    :cond_2
    :goto_1
    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedDevice;->notifyHierarchyChanged()V
    ...
    invoke-virtual {v2}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedList;->reloadWhiteList()V
    ...
    invoke-virtual {v2, v4}, Lcom/android/settings_ex/wifi/mobileap/WifiApAllowedList;->removeSelectedDevice(Ljava/lang/String;)V
