...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-static {}, Lcom/android/settings/wifi/WifiSettings;->access$4600()Landroid/net/wifi/WifiConfiguration;
    ...
    .line 3713
    iget-object v0, p0, Lcom/android/settings/wifi/WifiSettings$34;->this$0:Lcom/android/settings/wifi/WifiSettings;
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/WifiSettings$34;->this$0:Lcom/android/settings/wifi/WifiSettings;

    # getter for: Lcom/android/settings/wifi/WifiSettings;->mConnectListener:Landroid/net/wifi/WifiManager$ActionListener;
    invoke-static {v2}, Lcom/android/settings/wifi/WifiSettings;->access$4700(Lcom/android/settings/wifi/WifiSettings;)Landroid/net/wifi/WifiManager$ActionListener;
    ...
    invoke-static {v0, v1, v2}, Lcom/android/settings/wifi/WifiSettings;->access$4800(Lcom/android/settings/wifi/WifiSettings;Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiManager$ActionListener;)V

    .line 3714
    const/4 v0, 0x0

    # setter for: Lcom/android/settings/wifi/WifiSettings;->tempConfig:Landroid/net/wifi/WifiConfiguration;
    invoke-static {v0}, Lcom/android/settings/wifi/WifiSettings;->access$4602(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/WifiConfiguration;
