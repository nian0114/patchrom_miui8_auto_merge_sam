...
.method final addLocked(Lcom/android/server/am/TaskRecord;)V
    ...
    iget-object v11, p0, Lcom/android/server/am/RecentTasks;->mService:Lcom/android/server/am/ActivityManagerService;
    ...
    :cond_7
    invoke-direct {p0, p1, v8}, Lcom/android/server/am/RecentTasks;->moveAffiliatedTasksToFront(Lcom/android/server/am/TaskRecord;I)Z
    ...
    invoke-virtual {p0, p1, v11}, Lcom/android/server/am/RecentTasks;->trimForTaskLocked(Lcom/android/server/am/TaskRecord;Z)I
    ...
    invoke-virtual {p0, v11}, Lcom/android/server/am/RecentTasks;->remove(I)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v11}, Lcom/android/server/am/RecentTasks;->cleanupLocked(I)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/am/RecentTasks;->indexOf(Ljava/lang/Object;)I
    ...
    .restart local v8    # "taskIndex":I
    :goto_5
    invoke-virtual {p0, v8, p1}, Lcom/android/server/am/RecentTasks;->add(ILjava/lang/Object;)V
