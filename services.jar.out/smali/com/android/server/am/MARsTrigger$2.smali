...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v9, v0}, Lcom/android/server/am/MARsTrigger;->access$1600(Lcom/android/server/am/MARsTrigger;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    # invokes: Lcom/android/server/am/MARsTrigger;->triggerPolicy(ILjava/lang/String;)V
    invoke-static {v7, v8, v9}, Lcom/android/server/am/MARsTrigger;->access$1700(Lcom/android/server/am/MARsTrigger;ILjava/lang/String;)V
    ...
    invoke-static {v9}, Lcom/android/server/am/MARsTrigger;->access$1800(Lcom/android/server/am/MARsTrigger;)J
    ...
    invoke-static {v7}, Lcom/android/server/am/MARsTrigger;->access$1900(Lcom/android/server/am/MARsTrigger;)J
    ...
    invoke-static {v7, v8, v9}, Lcom/android/server/am/MARsTrigger;->access$1902(Lcom/android/server/am/MARsTrigger;J)J
    ...
    # invokes: Lcom/android/server/am/MARsTrigger;->actionToString(Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v8, v0}, Lcom/android/server/am/MARsTrigger;->access$1600(Lcom/android/server/am/MARsTrigger;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    # invokes: Lcom/android/server/am/MARsTrigger;->triggerPolicy(ILjava/lang/String;)V
    invoke-static {v7, v9, v8}, Lcom/android/server/am/MARsTrigger;->access$1700(Lcom/android/server/am/MARsTrigger;ILjava/lang/String;)V
    ...
    invoke-static {v9}, Lcom/android/server/am/MARsTrigger;->access$2000(Lcom/android/server/am/MARsTrigger;)J
    ...
    # invokes: Lcom/android/server/am/MARsTrigger;->triggerPolicy(ILjava/lang/String;)V
    invoke-static {v7, v10, v8}, Lcom/android/server/am/MARsTrigger;->access$1700(Lcom/android/server/am/MARsTrigger;ILjava/lang/String;)V
    ...
    invoke-static {v7, v5}, Lcom/android/server/am/MARsTrigger;->access$2200(Lcom/android/server/am/MARsTrigger;Ljava/lang/String;)I
    ...
    :cond_f
    const-string v7, "com.android.server.am.MARS_TRIGGER_UDS_POLICY"
    ...
    .line 434
    .restart local v4    # "packageList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    if-eqz v4, :cond_10
    ...
    invoke-virtual {v7, v4}, Lcom/android/server/am/MARsPolicyManager;->updateUDSPackages(Ljava/util/ArrayList;)V
    ...
    # invokes: Lcom/android/server/am/MARsTrigger;->triggerPolicy(ILjava/lang/String;)V
    invoke-static {v7, v11, v8}, Lcom/android/server/am/MARsTrigger;->access$1700(Lcom/android/server/am/MARsTrigger;ILjava/lang/String;)V
    ...
    .end local v1    # "extras":Landroid/os/Bundle;
    :cond_11
    const-string v7, "com.android.server.am.MARS_CANCEL_UDS_POLICY"
    ...
    invoke-virtual {v7, v8, v11}, Lcom/android/server/am/MARsPolicyManager;->cancelPolicy(Ljava/lang/String;I)V
