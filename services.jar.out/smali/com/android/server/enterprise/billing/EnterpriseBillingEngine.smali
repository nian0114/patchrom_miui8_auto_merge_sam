...
.method public getApplicationsForConnection(Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v20, "getApplicationsForConnection - start : "
    ...
    const-string v20, "getApplicationsForConnection Invalid parameter- "
    ...
    const-string v20, "getApplicationsForConnection - end : "
...
.method public getContainersForConnection(Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v5, "getContainersUsingProfile - start : "
    ...
    const-string v5, "getContainersUsingProfile - end : "
    ...
    const-string v5, "getContainersUsingProfile Invalid parameter- "
...
.method protected handleProfile(Ljava/lang/String;)V
    ...
    const-string v12, "handle - start - individual profile - "
    ...
    const-string v12, "handle - start - for profile - "
    ...
    const-string v12, "handle - default apn type set for profile - "
    ...
    const-string v12, "handle - current active apn for profile - "
    ...
    const-string v12, "handle - current telephony active apns - "
    ...
    const-string v12, "handle - Eapntype of current profile from service storage - "
    ...
    const-string v11, "handle - apn should be changed"
    ...
    const-string v12, "handle - matching apn from policy storage for active telephony apns - "
    ...
    const-string v11, "handle - changed current apn to its defaulttype in telephony db"
    ...
    const-string v12, "handle - default apn type of new eapn - "
    ...
    const-string v12, "handle - added active apn for profile - "
    ...
    const-string v12, "handle - update eapn type of new eapn in telephony db - "
    ...
    const-string v12, "handle - end - for profile - "
    ...
    const-string v12, "handle - for active apn, "
    ...
    const-string v12, "handle - update apntype of active apn in telephony db - "
    ...
    const-string v11, "handle - current apn is sufficient"
...
.method public isEnterpriseAPN(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v17, "isEnterpriseAPN - Start: "
    ...
    const-string v17, "isEnterpriseAPN - checking active profile - "
    ...
    const-string v17, "isEnterpriseAPN - found enterprise apn - "
    ...
    const-string v17, "isEnterpriseAPN - End: "
    ...
    const-string v17, "isEnterpriseAPN - failed -"
...
.method protected isPrimarySimDataActive()Z
    ...
    const-string v2, "isPrimarySimDataActive - start - "
    ...
    const-string v3, "isPrimarySimDataActive - slotId - "
...
.method public removeAllUidByTAG(Ljava/lang/String;)Z
    ...
    const-string v1, "removeAllUidByTAG - "
...
.method public removeContainerFromExceptionList(Ljava/lang/String;I)I
    ...
    const-string v2, "removeContainerFromExceptionList called by VPN inside enterpriseBillingService for container- "
...
.method public removeUIDListFromExceptionList(Ljava/lang/String;Ljava/util/Map;)I
    ...
    const-string v1, "removeUIDListFromExceptionList called by VPN inside enterpriseBillingService for packages"
