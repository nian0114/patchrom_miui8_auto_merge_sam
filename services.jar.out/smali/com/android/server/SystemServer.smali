...
.method private startOtherServices()V
    ...
    .line 654
    .local v160, "networkPolicy":Lcom/android/server/net/NetworkPolicyManagerService;
    const/16 v69, 0x0
    ...
    .line 657
    .local v185, "serviceDiscovery":Lcom/android/server/NsdService;
    const/16 v215, 0x0

    .line 658
    .local v215, "wm":Lcom/android/server/wm/WindowManagerService;
    const/16 v200, 0x0

    .line 659
    .local v200, "usb":Lcom/android/server/usb/UsbService;
    const/16 v183, 0x0

    .line 660
    .local v183, "serial":Lcom/android/server/SerialService;
    const/16 v164, 0x0
    ...
    .line 678
    .local v171, "quickconnect":Lcom/android/server/QuickConnectService;
    const/16 v194, 0x0
    ...
    .line 690
    .local v181, "sdpService":Lcom/android/server/SdpManagerService;
    const/16 v179, 0x0

    .line 693
    .local v179, "sdpLogService":Lcom/android/server/SdpLogService;
    const/16 v102, 0x0
    ...
    .line 733
    new-instance v190, Lcom/android/server/TelephonyRegistry;

    move-object/from16 v0, v190

    invoke-direct {v0, v5}, Lcom/android/server/TelephonyRegistry;-><init>(Landroid/content/Context;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_8c
    ...
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_8d
    ...
    .line 741
    .local v201, "versionInfo":Landroid/os/Bundle;
    const-string v6, "2.0"
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_7
    .catch Ljava/lang/Throwable; {:try_start_7 .. :try_end_7} :catch_96
    .catch Ljava/lang/RuntimeException; {:try_start_7 .. :try_end_7} :catch_8e
    ...
    .catch Ljava/lang/RuntimeException; {:try_start_b .. :try_end_b} :catch_8f
    ...
    .catch Ljava/lang/RuntimeException; {:try_start_d .. :try_end_d} :catch_90
    ...
    .line 885
    new-instance v203, Lcom/android/server/VibratorService;
    ...
    .line 891
    new-instance v197, Lcom/samsung/android/toolbox/TwToolBoxService;
    ...
    .line 892
    .local v197, "toolbox":Lcom/samsung/android/toolbox/TwToolBoxService;
    ...
    .line 903
    .end local v197    # "toolbox":Lcom/samsung/android/toolbox/TwToolBoxService;
    :cond_3
    const-string v6, "1"
    ...
    .line 910
    new-instance v195, Lcom/android/server/TimaService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_1d
    .catch Ljava/lang/Throwable; {:try_start_1d .. :try_end_1d} :catch_95
    .catch Ljava/lang/RuntimeException; {:try_start_1d .. :try_end_1d} :catch_91
    ...
    .line 922
    new-instance v193, Lcom/android/server/TimaObserver;
    ...
    .restart local v192    # "timaObserver":Lcom/android/server/TimaObserver;
    :goto_e
    :try_start_20
    const-string v6, "3.0"
    ...
    .line 939
    :try_start_21
    invoke-virtual/range {v121 .. v121}, Lcom/android/server/IcccManagerService;->getTrustedBootData()I
    ...
    .line 957
    .local v131, "keyStoreClass":Ljava/lang/Class;
    invoke-virtual/range {v131 .. v131}, Ljava/lang/Class;->newInstance()Ljava/lang/Object;
    ...
    .end local v121    # "icccService":Lcom/android/server/IcccManagerService;
    .end local v131    # "keyStoreClass":Ljava/lang/Class;
    .end local v196    # "timaversion":Z
    :cond_4
    :goto_10
    const/16 v107, 0x1
    ...
    check-cast v186, Landroid/os/IBinder;

    .line 1003
    .local v186, "ssrmService":Landroid/os/IBinder;
    ...
    .end local v186    # "ssrmService":Landroid/os/IBinder;
    :goto_13
    :try_start_27
    const-string v6, "SystemServer"
    ...
    .line 1019
    .local v209, "watchdog":Lcom/android/server/Watchdog;
    move-object/from16 v0, p0
    ...
    .line 1034
    .local v178, "scontextClassLoader":Ldalvik/system/PathClassLoader;
    ...
    .end local v178    # "scontextClassLoader":Ldalvik/system/PathClassLoader;
    :cond_8
    :goto_14
    :try_start_2b
    move-object/from16 v0, p0
    ...
    .line 1080
    invoke-virtual/range {v215 .. v215}, Lcom/android/server/wm/WindowManagerService;->getInputMonitor()Lcom/android/server/wm/InputMonitor;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_2f
    .catch Ljava/lang/Throwable; {:try_start_2f .. :try_end_2f} :catch_94
    .catch Ljava/lang/RuntimeException; {:try_start_2f .. :try_end_2f} :catch_93
    ...
    .end local v191    # "timaEnabled":Z
    .end local v201    # "versionInfo":Landroid/os/Bundle;
    .end local v203    # "vibrator":Lcom/android/server/VibratorService;
    .end local v209    # "watchdog":Lcom/android/server/Watchdog;
    .restart local v202    # "vibrator":Lcom/android/server/VibratorService;
    :goto_1a
    const/16 v187, 0x0

    .line 1128
    .local v187, "statusBar":Lcom/android/server/statusbar/StatusBarManagerService;
    const/16 v167, 0x0

    .line 1129
    .local v167, "notification":Landroid/app/INotificationManager;
    const/16 v123, 0x0
    ...
    .line 1131
    .local v207, "wallpaper":Lcom/android/server/wallpaper/WallpaperManagerService;
    const/16 v132, 0x0
    ...
    .line 1133
    .local v174, "sLocation":Landroid/os/IBinder;
    const/16 v79, 0x0
    ...
    .line 1139
    .local v204, "vrManager":Lcom/android/server/VRManagerService;
    const/16 v49, 0x0
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_32
    .catch Ljava/lang/Throwable; {:try_start_32 .. :try_end_32} :catch_8b
    ...
    :goto_1c
    :try_start_34
    invoke-virtual/range {v215 .. v215}, Lcom/android/server/wm/WindowManagerService;->displayReady()V
    :try_end_34
    ...
    .line 1178
    .local v168, "pM":Landroid/content/pm/PackageManager;
    if-eqz v168, :cond_b
    ...
    .end local v168    # "pM":Landroid/content/pm/PackageManager;
    :cond_b
    :goto_1e
    const/16 v81, 0x0
    ...
    .local v173, "sAccessoryManager":Lcom/samsung/accessory/manager/SAccessoryManager;
    :try_start_37
    ...
    :try_end_37
    .catch Ljava/lang/Throwable; {:try_start_37 .. :try_end_37} :catch_89

    move-object/from16 v172, v173

    .line 1247
    .end local v170    # "pm":Landroid/content/pm/PackageManager;
    .end local v173    # "sAccessoryManager":Lcom/samsung/accessory/manager/SAccessoryManager;
    ...
    .line 1288
    new-instance v205, Lcom/android/server/VRManagerService;
    ...
    .line 1289
    .end local v204    # "vrManager":Lcom/android/server/VRManagerService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_3c
    .catch Ljava/lang/Throwable; {:try_start_3c .. :try_end_3c} :catch_88

    move-object/from16 v204, v205

    .line 1298
    .end local v205    # "vrManager":Lcom/android/server/VRManagerService;
    .restart local v204    # "vrManager":Lcom/android/server/VRManagerService;
    :goto_24
    const-string v6, "SystemServer"
    ...
    :try_end_3f
    .catch Landroid/os/RemoteException; {:try_start_3f .. :try_end_3f} :catch_87
    ...
    .line 1334
    new-instance v135, Lcom/android/server/LockSettingsService;
    ...
    .local v135, "lockSettings":Lcom/android/server/LockSettingsService;
    :try_start_41
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_41
    .catch Ljava/lang/Throwable; {:try_start_41 .. :try_end_41} :catch_86

    move-object/from16 v134, v135

    .line 1340
    .end local v135    # "lockSettings":Lcom/android/server/LockSettingsService;
    ...
    invoke-static {v6, v7}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_43
    .catch Ljava/lang/Throwable; {:try_start_43 .. :try_end_43} :catch_85
    ...
    .line 1365
    new-instance v182, Lcom/android/server/SdpManagerService;
    ...
    .line 1366
    .end local v181    # "sdpService":Lcom/android/server/SdpManagerService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_45
    .catch Ljava/lang/Throwable; {:try_start_45 .. :try_end_45} :catch_84

    move-object/from16 v181, v182

    .line 1371
    .end local v182    # "sdpService":Lcom/android/server/SdpManagerService;
    .restart local v181    # "sdpService":Lcom/android/server/SdpManagerService;
    :goto_2a
    :try_start_46
    const-string v6, "SystemServer"
    ...
    .line 1372
    new-instance v180, Lcom/android/server/SdpLogService;
    ...
    .line 1373
    .end local v179    # "sdpLogService":Lcom/android/server/SdpLogService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_47
    .catch Ljava/lang/Throwable; {:try_start_47 .. :try_end_47} :catch_83

    move-object/from16 v179, v180

    .line 1382
    .end local v180    # "sdpLogService":Lcom/android/server/SdpLogService;
    .restart local v179    # "sdpLogService":Lcom/android/server/SdpLogService;
    :goto_2b
    :try_start_48
    const-string v6, "SystemServer"
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_49
    .catch Ljava/lang/Throwable; {:try_start_49 .. :try_end_49} :catch_82
    ...
    invoke-static {v6, v7}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_4b
    .catch Ljava/lang/Throwable; {:try_start_4b .. :try_end_4b} :catch_81
    ...
    .line 1406
    new-instance v188, Lcom/android/server/statusbar/StatusBarManagerService;
    ...
    .line 1407
    .end local v187    # "statusBar":Lcom/android/server/statusbar/StatusBarManagerService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_4d
    .catch Ljava/lang/Throwable; {:try_start_4d .. :try_end_4d} :catch_80

    move-object/from16 v187, v188

    .line 1413
    .end local v188    # "statusBar":Lcom/android/server/statusbar/StatusBarManagerService;
    .restart local v187    # "statusBar":Lcom/android/server/statusbar/StatusBarManagerService;
    :cond_16
    :goto_2e
    if-nez v99, :cond_17
    ...
    .line 1462
    new-instance v199, Lcom/android/server/TextServicesManagerService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_53
    .catch Ljava/lang/Throwable; {:try_start_53 .. :try_end_53} :catch_7f
    ...
    .local v162, "networkScore":Lcom/android/server/NetworkScoreService;
    :try_start_55
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_55
    .catch Ljava/lang/Throwable; {:try_start_55 .. :try_end_55} :catch_7e

    move-object/from16 v161, v162

    .line 1479
    .end local v162    # "networkScore":Lcom/android/server/NetworkScoreService;
    ...
    .line 1480
    new-instance v163, Lcom/android/server/net/NetworkStatsService;
    ...
    .local v163, "networkStats":Lcom/android/server/net/NetworkStatsService;
    :try_start_57
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_57
    .catch Ljava/lang/Throwable; {:try_start_57 .. :try_end_57} :catch_7d

    move-object/from16 v8, v163

    .line 1487
    .end local v163    # "networkStats":Lcom/android/server/net/NetworkStatsService;
    ...
    .line 1492
    .end local v160    # "networkPolicy":Lcom/android/server/net/NetworkPolicyManagerService;
    ...
    invoke-static {v6, v4}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_59
    .catch Ljava/lang/Throwable; {:try_start_59 .. :try_end_59} :catch_7c
    ...
    :try_end_5b
    .catch Ljava/lang/Throwable; {:try_start_5b .. :try_end_5b} :catch_7b
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_61
    .catch Ljava/lang/Throwable; {:try_start_61 .. :try_end_61} :catch_7a
    ...
    :try_end_65
    .catch Landroid/os/RemoteException; {:try_start_65 .. :try_end_65} :catch_79
    ...
    .line 1697
    new-instance v133, Lcom/android/server/LocationManagerService;
    ...
    .local v133, "location":Lcom/android/server/LocationManagerService;
    :try_start_69
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_69
    .catch Ljava/lang/Throwable; {:try_start_69 .. :try_end_69} :catch_78

    move-object/from16 v132, v133

    .line 1704
    .end local v133    # "location":Lcom/android/server/LocationManagerService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_6b
    .catch Ljava/lang/Throwable; {:try_start_6b .. :try_end_6b} :catch_77
    ...
    .line 1744
    .local v175, "sLocationLoader":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    ...
    .end local v175    # "sLocationLoader":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    :goto_47
    const/16 v136, 0x0

    .line 1754
    .local v136, "mCPPInstance":Landroid/os/IBinder;
    const/16 v83, 0x0
    ...
    invoke-direct {v0, v6, v7}, Ldalvik/system/PathClassLoader;-><init>(Ljava/lang/String;Ljava/lang/ClassLoader;)V
    :try_end_70
    .catch Ljava/lang/Throwable; {:try_start_70 .. :try_end_70} :catch_76
    ...
    invoke-static {v6, v7}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_71
    .catch Ljava/lang/Throwable; {:try_start_71 .. :try_end_71} :catch_44
    ...
    .line 1785
    .local v166, "noparams":[Ljava/lang/Class;
    ...
    .line 1786
    .local v137, "mCPPSystemReady":Ljava/lang/reflect/Method;
    const/4 v6, 0x0
    ...
    .line 1796
    .end local v137    # "mCPPSystemReady":Ljava/lang/reflect/Method;
    .end local v166    # "noparams":[Ljava/lang/Class;
    :cond_25
    :goto_4a
    if-nez v99, :cond_26
    ...
    .line 1828
    new-instance v208, Lcom/android/server/wallpaper/WallpaperManagerService;
    ...
    .line 1829
    .end local v207    # "wallpaper":Lcom/android/server/wallpaper/WallpaperManagerService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_77
    .catch Ljava/lang/Throwable; {:try_start_77 .. :try_end_77} :catch_75

    move-object/from16 v207, v208

    .line 1836
    .end local v208    # "wallpaper":Lcom/android/server/wallpaper/WallpaperManagerService;
    .restart local v207    # "wallpaper":Lcom/android/server/wallpaper/WallpaperManagerService;
    :cond_28
    :goto_4e
    :try_start_78
    const-string v6, "SystemServer"
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_79
    .catch Ljava/lang/Throwable; {:try_start_79 .. :try_end_79} :catch_74
    ...
    .line 1872
    new-instance v184, Lcom/android/server/SerialService;
    ...
    .line 1873
    .end local v183    # "serial":Lcom/android/server/SerialService;
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_7c
    .catch Ljava/lang/Throwable; {:try_start_7c .. :try_end_7c} :catch_73

    move-object/from16 v183, v184

    .line 1883
    .end local v184    # "serial":Lcom/android/server/SerialService;
    .restart local v183    # "serial":Lcom/android/server/SerialService;
    :cond_2d
    :goto_51
    :try_start_7d
    const-string v6, "SystemServer"
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_81
    .catch Ljava/lang/Throwable; {:try_start_81 .. :try_end_81} :catch_72
    ...
    .line 1992
    .local v158, "mscsClass":Ljava/lang/Class;
    ...
    .line 2008
    .end local v158    # "mscsClass":Ljava/lang/Class;
    :goto_58
    :try_start_85
    const-string v6, "SystemServer"
    ...
    .restart local v164    # "networkTimeUpdater":Lcom/android/server/NetworkTimeUpdateService;
    :cond_33
    :goto_5b
    :try_start_88
    const-string v6, "SystemServer"
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_8c
    .catch Ljava/lang/Throwable; {:try_start_8c .. :try_end_8c} :catch_70
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_8e
    .catch Ljava/lang/Throwable; {:try_start_8e .. :try_end_8e} :catch_6f
    ...
    .line 2181
    new-instance v211, Ldalvik/system/PathClassLoader;
    ...
    .line 2184
    .local v211, "wbcClassLoader":Ldalvik/system/PathClassLoader;
    ...
    .line 2185
    .local v210, "wbcClass":Ljava/lang/Class;
    const/4 v6, 0x1
    ...
    .line 2187
    .local v212, "wbcObject":Ljava/lang/Object;
    const-string v6, "SystemServer"
    ...
    check-cast v212, Landroid/os/IBinder;

    .end local v212    # "wbcObject":Ljava/lang/Object;
    ...
    .end local v210    # "wbcClass":Ljava/lang/Class;
    .end local v211    # "wbcClassLoader":Ldalvik/system/PathClassLoader;
    :goto_62
    :try_start_92
    const-string v6, "SystemServer"
    ...
    .end local v83    # "cppClassLoader":Ldalvik/system/PathClassLoader;
    .end local v130    # "isWipowerEnabled":Z
    .end local v136    # "mCPPInstance":Landroid/os/IBinder;
    :goto_64
    if-nez v99, :cond_3c
    ...
    .line 2250
    :goto_66
    invoke-virtual/range {v215 .. v215}, Lcom/android/server/wm/WindowManagerService;->detectSafeMode()Z

    move-result v176

    .line 2251
    .local v176, "safeMode":Z
    move/from16 v0, v176
    ...
    :goto_6a
    :try_start_99
    invoke-virtual/range {v202 .. v202}, Lcom/android/server/VibratorService;->systemReady()V
    :try_end_99
    ...
    .line 2312
    :try_start_9a
    invoke-virtual/range {v134 .. v134}, Lcom/android/server/LockSettingsService;->systemReady()V
    :try_end_9a
    ...
    :cond_3f
    :try_start_9b
    invoke-virtual/range {v215 .. v215}, Lcom/android/server/wm/WindowManagerService;->systemReady()V
    :try_end_9b
    ...
    .line 2343
    :cond_40
    invoke-virtual/range {v215 .. v215}, Lcom/android/server/wm/WindowManagerService;->computeNewConfiguration()Landroid/content/res/Configuration;
    ...
    check-cast v206, Landroid/view/WindowManager;

    .line 2346
    .local v206, "w":Landroid/view/WindowManager;
    invoke-interface/range {v206 .. v206}, Landroid/view/WindowManager;->getDefaultDisplay()Landroid/view/Display;
    ...
    :goto_70
    :try_start_9f
    invoke-virtual/range {v181 .. v181}, Lcom/android/server/SdpManagerService;->systemReady()V
    :try_end_9f
    ...
    :goto_71
    :try_start_a0
    invoke-virtual/range {v179 .. v179}, Lcom/android/server/SdpLogService;->systemReady()V
    :try_end_a0
    ...
    .line 2393
    .restart local v201    # "versionInfo":Landroid/os/Bundle;
    const-string v6, "2.0"
    ...
    .end local v167    # "notification":Landroid/app/INotificationManager;
    .end local v172    # "sAccessoryManager":Lcom/samsung/accessory/manager/SAccessoryManager;
    .end local v174    # "sLocation":Landroid/os/IBinder;
    .end local v176    # "safeMode":Z
    .end local v187    # "statusBar":Lcom/android/server/statusbar/StatusBarManagerService;
    .end local v189    # "telephonyRegistry":Lcom/android/server/TelephonyRegistry;
    .end local v198    # "tsms":Lcom/android/server/TextServicesManagerService;
    .end local v204    # "vrManager":Lcom/android/server/VRManagerService;
    .end local v206    # "w":Landroid/view/WindowManager;
    .end local v207    # "wallpaper":Lcom/android/server/wallpaper/WallpaperManagerService;
    .restart local v111    # "entropyMixer":Lcom/android/server/EntropyMixer;
    .restart local v160    # "networkPolicy":Lcom/android/server/net/NetworkPolicyManagerService;
    ...
    :try_end_a3
    .catch Ljava/lang/RuntimeException; {:try_start_a3 .. :try_end_a3} :catch_1
    ...
    invoke-static {v6, v7, v0}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_a5
    .catch Ljava/lang/RuntimeException; {:try_start_a5 .. :try_end_a5} :catch_8f
    ...
    .end local v104    # "e":Ljava/lang/Throwable;
    .end local v202    # "vibrator":Lcom/android/server/VibratorService;
    .restart local v191    # "timaEnabled":Z
    ...
    .restart local v196    # "timaversion":Z
    :cond_44
    :try_start_a9
    const-string v6, "SystemServer"
    ...
    .restart local v209    # "watchdog":Lcom/android/server/Watchdog;
    :catch_15
    move-exception v104
    ...
    invoke-static {v6, v7, v0}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_ac
    .catch Ljava/lang/RuntimeException; {:try_start_ac .. :try_end_ac} :catch_16
    ...
    .restart local v134    # "lockSettings":Lcom/android/server/LockSettingsService;
    .restart local v147    # "mediaRouter":Lcom/android/server/media/MediaRouterService;
    .restart local v167    # "notification":Landroid/app/INotificationManager;
    .restart local v172    # "sAccessoryManager":Lcom/samsung/accessory/manager/SAccessoryManager;
    .restart local v174    # "sLocation":Landroid/os/IBinder;
    .restart local v187    # "statusBar":Lcom/android/server/statusbar/StatusBarManagerService;
    .restart local v189    # "telephonyRegistry":Lcom/android/server/TelephonyRegistry;
    .restart local v198    # "tsms":Lcom/android/server/TextServicesManagerService;
    .restart local v202    # "vibrator":Lcom/android/server/VibratorService;
    ...
    .line 1204
    .local v169, "packageMgr":Landroid/content/pm/PackageManager;
    ...
    :try_end_ad
    .catch Ljava/lang/Throwable; {:try_start_ad .. :try_end_ad} :catch_1d
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_ae
    .catch Ljava/lang/Throwable; {:try_start_ae .. :try_end_ae} :catch_8a
    ...
    .end local v87    # "cryptState":Ljava/lang/String;
    .end local v104    # "e":Ljava/lang/Throwable;
    .end local v169    # "packageMgr":Landroid/content/pm/PackageManager;
    :catch_1e
    move-exception v104
    ...
    invoke-static {v7, v6}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_af
    .catch Ljava/lang/Throwable; {:try_start_af .. :try_end_af} :catch_37
    ...
    .line 1578
    .local v177, "salesCode":Ljava/lang/String;
    const-string v6, "ZVV"
    ...
    invoke-direct/range {v128 .. v128}, Landroid/content/Intent;-><init>()V

    .line 1580
    .local v128, "intent":Landroid/content/Intent;
    ...
    .line 1600
    .end local v128    # "intent":Landroid/content/Intent;
    .end local v177    # "salesCode":Ljava/lang/String;
    ...
    invoke-static {v7, v6}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_b1
    .catch Ljava/lang/Throwable; {:try_start_b1 .. :try_end_b1} :catch_38
    ...
    :try_end_b2
    .catch Ljava/lang/Throwable; {:try_start_b2 .. :try_end_b2} :catch_42
    ...
    invoke-static {v6, v7}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_b3
    .catch Ljava/lang/Throwable; {:try_start_b3 .. :try_end_b3} :catch_42
    ...
    .restart local v136    # "mCPPInstance":Landroid/os/IBinder;
    :cond_54
    :try_start_b4
    ...
    invoke-static {v6, v7}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_b4
    .catch Ljava/lang/Throwable; {:try_start_b4 .. :try_end_b4} :catch_44
    ...
    .line 1772
    .local v138, "mCPPositioningService":Ljava/lang/reflect/Constructor;
    const/4 v6, 0x1
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_b5
    .catch Ljava/lang/Throwable; {:try_start_b5 .. :try_end_b5} :catch_44
    ...
    .end local v47    # "arg":[Ljava/lang/Class;
    .end local v84    # "cppClassLoader":Ldalvik/system/PathClassLoader;
    .end local v138    # "mCPPositioningService":Ljava/lang/reflect/Constructor;
    .restart local v83    # "cppClassLoader":Ldalvik/system/PathClassLoader;
    :catch_45
    move-exception v104
    ...
    invoke-static {v7, v6}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_b6
    .catch Ljava/lang/Throwable; {:try_start_b6 .. :try_end_b6} :catch_4e
    ...
    invoke-static {v6, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_b7
    .catch Ljava/lang/Throwable; {:try_start_b7 .. :try_end_b7} :catch_51
    ...
    .line 1996
    .end local v104    # "e":Ljava/lang/Throwable;
    .restart local v158    # "mscsClass":Ljava/lang/Class;
    :cond_59
    const/4 v6, 0x1
    ...
    .line 1998
    .local v159, "mscsService":Landroid/os/IBinder;
    ...
    .end local v72    # "constructor":Ljava/lang/reflect/Constructor;
    .end local v158    # "mscsClass":Ljava/lang/Class;
    .end local v159    # "mscsService":Landroid/os/IBinder;
    :catch_53
    move-exception v104
    ...
    .line 2189
    .end local v104    # "e":Ljava/lang/Throwable;
    .restart local v130    # "isWipowerEnabled":Z
    :catch_5d
    move-exception v104
    ...
    .restart local v206    # "w":Landroid/view/WindowManager;
    :catch_68
    move-exception v104
    ...
    .line 1699
    .end local v132    # "location":Lcom/android/server/LocationManagerService;
    .restart local v133    # "location":Lcom/android/server/LocationManagerService;
    :catch_78
    move-exception v104
    ...
    .end local v8    # "networkStats":Lcom/android/server/net/NetworkStatsService;
    .restart local v160    # "networkPolicy":Lcom/android/server/net/NetworkPolicyManagerService;
    .restart local v163    # "networkStats":Lcom/android/server/net/NetworkStatsService;
    :catch_7d
    move-exception v104
    ...
    .line 1474
    .end local v161    # "networkScore":Lcom/android/server/NetworkScoreService;
    .restart local v162    # "networkScore":Lcom/android/server/NetworkScoreService;
    :catch_7e
    move-exception v104
    ...
    .line 1336
    .end local v134    # "lockSettings":Lcom/android/server/LockSettingsService;
    .restart local v135    # "lockSettings":Lcom/android/server/LockSettingsService;
    :catch_86
    move-exception v104
    ...
    .restart local v173    # "sAccessoryManager":Lcom/samsung/accessory/manager/SAccessoryManager;
    :catch_89
    move-exception v104
    ...
    .restart local v87    # "cryptState":Ljava/lang/String;
    .restart local v169    # "packageMgr":Landroid/content/pm/PackageManager;
    :catch_8a
    move-exception v104
