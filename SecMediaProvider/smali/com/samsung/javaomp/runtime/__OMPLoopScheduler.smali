...
.method private declared-synchronized prepareDynamicChunks(Lcom/samsung/javaomp/runtime/__OMPWorkshare;)V
    ...
    invoke-direct {v6, v4, v5, v0, v1}, Lcom/samsung/javaomp/runtime/__OMPChunk;-><init>(JJ)V

    invoke-virtual {v3, v6}, Ljava/util/LinkedList;->offer(Ljava/lang/Object;)Z
    ...
    invoke-direct {v0, v3}, Ljava/util/concurrent/LinkedBlockingQueue;-><init>(Ljava/util/Collection;)V
...
.method private declared-synchronized prepareGuidedChunks(Lcom/samsung/javaomp/runtime/__OMPLoop;Lcom/samsung/javaomp/runtime/__OMPWorkshare;)V
    ...
    const-string v3, "Oops. Non-positive sized chunk encountered."
    ...
    iget-wide v6, v0, Lcom/samsung/javaomp/runtime/__OMPLoop;->incr:J
    ...
    invoke-direct {v9, v6, v7, v2, v3}, Lcom/samsung/javaomp/runtime/__OMPChunk;-><init>(JJ)V
    ...
    invoke-direct {v2, v5}, Ljava/util/concurrent/LinkedBlockingQueue;-><init>(Ljava/util/Collection;)V
...
.method private updateLoopData(Lcom/samsung/javaomp/runtime/__OMPLoop;Lcom/samsung/javaomp/runtime/__OMPWorkshare;)Z
    ...
    :cond_9
    iget-wide v2, v0, Lcom/samsung/javaomp/runtime/__OMPChunk;->end:J

    iget-wide v4, p2, Lcom/samsung/javaomp/runtime/__OMPWorkshare;->end:J
    ...
    iput-wide v2, p1, Lcom/samsung/javaomp/runtime/__OMPLoop;->staticTrip:J

    :goto_5
    iget-wide v2, v0, Lcom/samsung/javaomp/runtime/__OMPChunk;->start:J

    iput-wide v2, p1, Lcom/samsung/javaomp/runtime/__OMPLoop;->myStart:J
