...
.method private updateNetworkModeForChina()V
    ...
    const-string v31, "[updateNetworkModeForChina] mMainStackSubId:"
...
.method private declared-synchronized updateSubscriptionInfoByIccId()V
    ...
    .line 1378
    sget-boolean v25, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->SHIP_BUILD:Z
    ...
    .line 1433
    .local v20, "subCtrlr":Lcom/android/internal/telephony/SubscriptionController;
    ...
    sget-object v26, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mPhoneOnKey:[Ljava/lang/String;
    ...
    const-string v26, "updateSubscriptionInfoByIccId: Set sub_state:"
    ...
    .end local v20    # "subCtrlr":Lcom/android/internal/telephony/SubscriptionController;
    ...
    const-string v26, "insertedSimStatus = "
    ...
    invoke-virtual/range {v25 .. v27}, Lcom/android/internal/telephony/SubscriptionController;->setSubState(II)I
    ...
    const-string v26, "else, insertedSimStatus = "
    ...
    :cond_20
    const-string v25, "PROPERTY_SIM_STATE UNKNOWN, ignore"
    ...
    .line 1559
    .local v22, "subInfos":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/SubscriptionInfo;>;"
    if-nez v22, :cond_30
    ...
    .line 1572
    .local v23, "temp":Landroid/telephony/SubscriptionInfo;
    invoke-static {}, Landroid/telephony/TelephonyManager;->getDefault()Landroid/telephony/TelephonyManager;
    ...
    .end local v22    # "subInfos":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/SubscriptionInfo;>;"
    .end local v23    # "temp":Landroid/telephony/SubscriptionInfo;
    :cond_28
    ...
    .line 1559
    .restart local v22    # "subInfos":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/SubscriptionInfo;>;"
    :cond_30
