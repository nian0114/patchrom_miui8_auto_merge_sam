...
.method private deleteAndCreatePhone(I)V
    ...
    invoke-virtual {v11}, Lcom/android/internal/telephony/PhoneBase;->getPhoneName()Ljava/lang/String;
    ...
    const-string v12, "Switching Voice Phone : "
    ...
    invoke-direct {p0, v11}, Lcom/android/internal/telephony/PhoneProxy;->logd(Ljava/lang/String;)V
    ...
    iget v11, p0, Lcom/android/internal/telephony/PhoneProxy;->mPhoneId:I

    invoke-static {v11}, Lcom/android/internal/telephony/PhoneFactory;->getCdmaPhone(I)Lcom/android/internal/telephony/Phone;
    ...
    const-string v11, "persist.radio.last.phonetype"
    ...
    iget-object v13, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-static {v11, v12, v13}, Lcom/samsung/android/telephony/MultiSimManager;->setTelephonyProperty(Ljava/lang/String;ILjava/lang/String;)V
    ...
    iget-object v12, v12, Lcom/android/internal/telephony/PhoneBase;->mEccNums:Ljava/lang/String;

    iput-object v12, v11, Lcom/android/internal/telephony/PhoneBase;->mEccNums:Ljava/lang/String;

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "Copy mEccNums - oldPhone.mEccNums: "
    ...
    const-string v12, ", mActivePhone.mEccNums: "
    ...
    iget-boolean v11, v11, Lcom/android/internal/telephony/PhoneBase;->mIsPhoneInEcmState:Z
    ...
    const-string v11, "GSMPhone is in ECM"
    ...
    invoke-virtual {v11}, Lcom/android/internal/telephony/PhoneBase;->runEmergencyCallbackMode()V
    ...
    invoke-virtual {p0, v11, v12}, Lcom/android/internal/telephony/PhoneProxy;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v10, v11, Lcom/android/internal/telephony/ServiceStateTracker;->mSavedTimeZone:Ljava/lang/String;

    .local v10, "savedTimeZone":Ljava/lang/String;
    move-object v11, v3
    ...
    iget-wide v8, v11, Lcom/android/internal/telephony/ServiceStateTracker;->mSavedTime:J
    ...
    iget-wide v6, v11, Lcom/android/internal/telephony/ServiceStateTracker;->mSavedAtTime:J
    ...
    const-string v12, "Copy time information to new phone (mSavedTimeZone: "
    ...
    iput-object v10, v11, Lcom/android/internal/telephony/ServiceStateTracker;->mSavedTimeZone:Ljava/lang/String;
    ...
    iput-wide v8, v11, Lcom/android/internal/telephony/ServiceStateTracker;->mSavedTime:J
    ...
    iput-wide v6, v11, Lcom/android/internal/telephony/ServiceStateTracker;->mSavedAtTime:J

    .end local v6    # "savedAtTime":J
    .end local v8    # "savedTime":J
    .end local v10    # "savedTimeZone":Ljava/lang/String;
    :cond_5
    if-eqz v3, :cond_6
    ...
    iget-boolean v5, v11, Lcom/android/internal/telephony/ServiceStateTracker;->isReadyReceiveCall:Z

    .local v5, "readyReceiveCall":Z
    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "Copy readyReceiveCall to new phone (isReadyReceiveCall: "
    ...
    iput-boolean v5, v11, Lcom/android/internal/telephony/ServiceStateTracker;->isReadyReceiveCall:Z

    .end local v5    # "readyReceiveCall":Z
    :cond_6
    if-eqz v3, :cond_7
    ...
    invoke-virtual {v11, v12}, Lcom/android/internal/telephony/CallManager;->registerPhone(Lcom/android/internal/telephony/Phone;)Z

    if-eqz v1, :cond_8

    iget-object v11, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    invoke-interface {v11, v1}, Lcom/android/internal/telephony/Phone;->acquireOwnershipOfImsPhone(Lcom/android/internal/telephony/imsphone/ImsPhone;)V

    :cond_8
    iget-object v11, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    invoke-interface {v11}, Lcom/android/internal/telephony/Phone;->startMonitoringImsService()V
    ...
    invoke-virtual {v11, v3}, Lcom/android/internal/telephony/CallManager;->unregisterPhone(Lcom/android/internal/telephony/Phone;)V

    const-string v11, "Disposing old phone.."
    ...
    const-string v11, "gsm.sim.selectnetwork"
    ...
    const-string v11, "com.samsung.intent.action.setCardDataInit"
    ...
    invoke-static {v2, v11, v12}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V

    .end local v2    # "intent":Landroid/content/Intent;
    :cond_b
    :goto_2
    const-string v11, "mModelChange modified to true because of model change."
    ...
    iput-boolean v12, v11, Lcom/android/internal/telephony/dataconnection/DctController;->mModelChange:Z
    ...
    invoke-static {v11}, Lcom/android/internal/telephony/PhoneFactory;->getGsmPhone(I)Lcom/android/internal/telephony/Phone;
    ...
    const-string v12, "deleteAndCreatePhone: newVoiceRadioTech="
    ...
    const-string v12, " is not CDMA or GSM (error) - aborting!"
    ...
    invoke-direct {p0, v11}, Lcom/android/internal/telephony/PhoneProxy;->loge(Ljava/lang/String;)V
    ...
    const-string v11, "com.samsung.intent.action.Slot1setCardDataInit"
    ...
    const-string v11, "gsm.sim.sixmode"
    ...
    const-string v11, "com.samsung.intent.action.setRuimCardDataInit"
