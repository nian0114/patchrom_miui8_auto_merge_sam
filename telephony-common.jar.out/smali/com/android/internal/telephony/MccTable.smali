...
.method public static updateMccMncConfiguration(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    const-string v16, "updateMccMncConfiguration mccmnc=\'"
    ...
    const-string v16, "\' fromServiceState="
    ...
    const-string v14, "persist.sys.override_mcc"

    invoke-static {v14}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    .local v12, "overrideMcc":Ljava/lang/String;
    ...
    const-string v16, "updateMccMncConfiguration overriding mccmnc=\'"
    ...
    .end local v12    # "overrideMcc":Ljava/lang/String;
    :cond_0
    ...
    invoke-virtual {v14}, Landroid/telephony/TelephonyManager;->getSimOperatorNumeric()Ljava/lang/String;
    ...
    const-string v16, "updateMccMncConfiguration defaultMccMnc="
    ...
    const-string v14, "persist.sys.locale"
    ...
    .local v9, "localeProp":Ljava/lang/String;
    const-string v14, ""
    ...
    invoke-static {v0, v10, v14}, Lcom/android/internal/telephony/MccTable;->getLocaleFromMcc(Landroid/content/Context;ILjava/lang/String;)Ljava/util/Locale;

    move-result-object v8

    .end local v9    # "localeProp":Ljava/lang/String;
    :cond_1
    if-eqz p2, :cond_3
    ...
    const-string v16, "Error parsing IMSI: "
    ...
    const-string v14, "ro.csc.countryiso_code"
    ...
    :cond_4
    iput v10, v1, Landroid/content/res/Configuration;->mcc:I

    iput v11, v1, Landroid/content/res/Configuration;->mnc:I
    ...
    invoke-virtual {v1, v8}, Landroid/content/res/Configuration;->setLocale(Ljava/util/Locale;)V
    ...
    iget v0, v1, Landroid/content/res/Configuration;->mcc:I
    ...
    iget v0, v1, Landroid/content/res/Configuration;->mnc:I
    ...
    invoke-interface {v14, v1}, Landroid/app/IActivityManager;->updateConfiguration(Landroid/content/res/Configuration;)V
    :try_end_3
    ...
    invoke-static {v0, v14}, Lcom/android/internal/telephony/MccTable;->setWifiCountryCodeFromMcc(Landroid/content/Context;I)V
