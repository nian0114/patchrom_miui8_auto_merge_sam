...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v8}, Lcom/android/nfc/cardemulation/AppChooserActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 177
    .local v5, "personaMgr":Landroid/os/PersonaManager;
    if-eqz v5, :cond_3
    ...
    .line 181
    .local v7, "userId":I
    invoke-static {v7}, Lcom/android/nfc/NfcService;->isContainerId(I)Z

    move-result v4

    .line 182
    .local v4, "isContainerId":Z
    if-eqz v4, :cond_0

    invoke-virtual {v5, v7}, Landroid/os/PersonaManager;->isNFCAllowed(I)Z
    ...
    invoke-virtual {v5}, Landroid/os/PersonaManager;->isKioskContainerExistOnDevice()Z
    ...
    .line 192
    .end local v2    # "i":I
    .end local v4    # "isContainerId":Z
    .end local v5    # "personaMgr":Landroid/os/PersonaManager;
    ...
    const-string v8, "failed_component"
    ...
    invoke-virtual {p0, p1, v0, v6, v1}, Lcom/android/nfc/cardemulation/AppChooserActivity;->onCreate(Landroid/os/Bundle;Ljava/lang/String;Ljava/util/ArrayList;Landroid/content/ComponentName;)V
...
.method protected onCreate(Landroid/os/Bundle;Ljava/lang/String;Ljava/util/ArrayList;Landroid/content/ComponentName;)V
    ...
    invoke-virtual {v0, v14}, Lcom/android/nfc/cardemulation/AppChooserActivity;->setFinishOnTouchOutside(Z)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget v3, v1, Lcom/android/nfc/cardemulation/AppChooserActivity$DisplayAppInfo;->displayUserId:I

    invoke-virtual {v2, v3}, Lcom/android/nfc/NfcService;->setSelectedUserId(I)V
