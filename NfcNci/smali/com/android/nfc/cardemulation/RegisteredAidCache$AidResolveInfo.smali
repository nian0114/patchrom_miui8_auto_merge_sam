...
.field offHostRouteToHost:Ljava/util/HashMap;
...
.method constructor <init>(Lcom/android/nfc/cardemulation/RegisteredAidCache;)V
    ...
    iput-object v0, p0, Lcom/android/nfc/cardemulation/RegisteredAidCache$AidResolveInfo;->offHostRouteToHost:Ljava/util/HashMap;
...
# virtual methods
.method public isInDefaultRoute()Z
    .locals 4

    .prologue
    .line 156
    iget-object v2, p0, Lcom/android/nfc/cardemulation/RegisteredAidCache$AidResolveInfo;->defaultService:Landroid/nfc/cardemulation/ApduServiceInfo;

    if-eqz v2, :cond_0

    .line 157
    iget-object v2, p0, Lcom/android/nfc/cardemulation/RegisteredAidCache$AidResolveInfo;->this$0:Lcom/android/nfc/cardemulation/RegisteredAidCache;

    iget-object v3, p0, Lcom/android/nfc/cardemulation/RegisteredAidCache$AidResolveInfo;->defaultService:Landroid/nfc/cardemulation/ApduServiceInfo;

    invoke-virtual {v2, v3}, Lcom/android/nfc/cardemulation/RegisteredAidCache;->isServiceInDefaultRoute(Landroid/nfc/cardemulation/ApduServiceInfo;)Z
    ...
    .line 160
    :cond_0
    iget-object v2, p0, Lcom/android/nfc/cardemulation/RegisteredAidCache$AidResolveInfo;->services:Ljava/util/List;
    ...
    invoke-virtual {v2, v1}, Lcom/android/nfc/cardemulation/RegisteredAidCache;->isServiceInDefaultRoute(Landroid/nfc/cardemulation/ApduServiceInfo;)Z
