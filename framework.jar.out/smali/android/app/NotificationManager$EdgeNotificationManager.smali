...
.method public postEdgeNotification(ILandroid/os/Bundle;)V
    ...
    const-string v2, "postEdgeNotification:"
    ...
    const-string v0, "samsung.notification.type"
...
.method public postEdgeNotificationByNormal(ILandroid/app/Notification;)V
    ...
    const-string v2, "postEdgeNotificationByNormal"
    ...
    const-string v1, "samsung.notification.type"

    const-string v2, "normal"

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "samsung.notification.pendingIntent"

    iget-object v2, p2, Landroid/app/Notification;->contentIntent:Landroid/app/PendingIntent;

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V

    const-string v1, "samsung.notification.when"
    ...
    const-string v2, "samsung.people.titles"

    invoke-virtual {v1, v2}, Landroid/os/Bundle;->remove(Ljava/lang/String;)V

    iget-object v1, p2, Landroid/app/Notification;->extras:Landroid/os/Bundle;

    const-string v2, "samsung.people.subTitles"

    invoke-virtual {v1, v2}, Landroid/os/Bundle;->remove(Ljava/lang/String;)V

    iget-object v1, p2, Landroid/app/Notification;->extras:Landroid/os/Bundle;

    const-string v2, "samsung.people.pendingIntents"

    invoke-virtual {v1, v2}, Landroid/os/Bundle;->remove(Ljava/lang/String;)V

    iget-object v1, p2, Landroid/app/Notification;->extras:Landroid/os/Bundle;

    const-string v2, "samsung.people.timestamps"
...
.method public removeEdgeNotification(ILandroid/os/Bundle;)V
    ...
    const-string v2, "removeEdgeNotification:"
...
.method public removeEdgeNotificationAllByNormal()V
    ...
    const-string v1, "samsung.notification.remove_all"
